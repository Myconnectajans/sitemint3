...
const Slider3 = () => {
  ...
  const sliderData = [
    ...
    },
    {
      ...
      description: "Restoranlar için özel QR menü",
    ...
    },
    {
      id: 3,
      title: "Kafe QR Menü",
      description: "Kafeler için modern QR menü",
    ...
    },
    {
      id: 4,
      title: "Bar QR Menü",
      description: "Barlar için özel QR menü",
    ...
    {
      id: 5,
      title: "Pizzeria QR Menü",
      description: "Pizza restoranları için QR menü",
    ...
    {
      id: 6,
      title: "Fast Food QR Menü",
      description: "Fast food için hızlı QR menü",
    ...
    },
    {
      id: 7,
      title: "Bar QR Menü",
      description: "Bar ve pub işletmeleri için menü",
    ...
    {
      id: 8,
      title: "Pastane QR Menü",
      description: "Pastane ve fırın için özel menü",
  ...
  const isWishlisted = (itemId) => {
    return wishlist.some(item => item.id === `slider3-${itemId}`);
  };
        ...
        <div style={{
          ...
          <div style={{
            ...
            <span style={{
              ...
              borderRadius: '20px',
              fontWeight: '500'
            }}>✓ Ürün ekleme çıkarma seçeneği</span>
            <span style={{
              fontSize: '14px',
              color: '#1e3a8a',
              background: '#f0f4ff',
              ...
              borderRadius: '20px',
              fontWeight: '500'
            }}>✓ Ürün görseli değiştirme seçeneği</span>
            <span style={{
              fontSize: '14px',
              color: '#1e3a8a',
              background: '#f0f4ff',
              ...
              borderRadius: '20px',
              fontWeight: '500'
            }}>✓ Fiyat değiştirme seçeneği</span>
          </div>
        </div>
        ...
        <div style={{
          ...
          <div style={{
            ...
            {visibleProducts.map((item) => (
              ...
              >
                {/* Görsel */}
                <Link href={`/product-details/slider3-${item.id}`} style={{ textDecoration: 'none', color: 'inherit' }}>
                  <div style={{
                    height: '200px',
                ...
                <div style={{
                  ...
                  <div>
                    ...
                    <Link href={`/product-details/slider3-${item.id}`}>
                      <button style={{
                        width: '100%',
                        padding: '10px',
                        background: '#1e3a8a',
