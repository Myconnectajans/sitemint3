...
const Slider1 = () => {
  ...
  const sliderData = [
    ...
    {
      id: 7,
      title: "Kurumsal Blog Sitesi",
      description: "Profesyonel içerik yönetim sistemi",
    ...
    },
    {
      ...
      description: "Yaratıcı portfolyo ve CV sitesi",
  ...
  const isWishlisted = (itemId) => {
    return wishlist.some(item => item.id === `slider1-${itemId}`);
  };
        ...
        <div style={{
          ...
          <div style={{
            ...
            <span style={{
              ...
              borderRadius: '20px',
              fontWeight: '500'
            }}>✓ 3 İş günü içerisinde siteniz yayında</span>
            <span style={{
              fontSize: '14px',
              color: '#1e3a8a',
              background: '#f0f4ff',
              ...
              borderRadius: '20px',
              fontWeight: '500'
            }}>✓ Modern ve mobil uyumlu tasarım</span>
            <span style={{
              fontSize: '14px',
              color: '#1e3a8a',
              background: '#f0f4ff',
            ...
            <span style={{
              ...
              borderRadius: '20px',
              fontWeight: '500'
            }}>✓ İlk yıl domain hosting hediye</span>
            <span style={{
              fontSize: '14px',
              color: '#1e3a8a',
              background: '#f0f4ff',
        ...
        <div style={{
          ...
          <div style={{
            ...
            {visibleProducts.map((item) => (
              ...
              >
                {/* Görsel */}
                <Link href={`/product-details/slider1-${item.id}`} style={{ textDecoration: 'none', color: 'inherit' }}>
                  <div style={{
                    height: '200px',
                ...
                <div style={{
                  ...
                  <div>
                    ...
                    <Link href={`/product-details/slider1-${item.id}`}>
                      <button style={{
                        width: '100%',
                        padding: '10px',
                        background: '#1e3a8a',
