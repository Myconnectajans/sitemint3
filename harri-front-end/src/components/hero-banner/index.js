...
const slider_data = [
  {
    ...
    pre_title: (
      <>
        Hayalindeki <br /> Web Sitesi Tasarımları
      </>
    ),
    title: (
      <>
        İşine Değer Katacak <br /> Modern Temalar
      </>
    ),
    img: slider_img_1,
  },
  {
    ...
    pre_title: (
      <>
        Kurumsal <br /> Kartvizitler
      </>
    ),
    title: (
      <>
        İlk İzlenim <br /> Her Şeydir!
      </>
    ),
    img: slider_img_2,
  },
  {
    ...
    pre_title: (
      <>
        Magnet ve <br /> QR Menü Çözümleri
      </>
    ),
    title: (
      <>
        Markanı <br /> Her Yerde Göster
      </>
    ),
    img: slider_img_3,
  },
